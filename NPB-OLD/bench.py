...
class UnifiedNPBAnalyzer:
    ...
    def parse_npb_output(self, output: str) -> Tuple[bool, float, float, str, str, int, int, str, str]:
        verification = False
        mflops = 0.0
        time_val = 0.0
        ...
        if "VERIFICATION SUCCESSFUL" in output or "Verification    =               SUCCESSFUL" in output:
            verification = True
        ...
        for line in output.split('\n'):
            ...
            if 'Mop/s total' in line and '=' in line:
                ...
                try:
                    ...
                    pass
            elif 'CPU Time' in line and '=' in line:
                try:
                    time_val = float(line.split('=')[1].strip())
                except:
                    pass
                ...
                try:
                    ...
                    pass
            elif 'Size' in line and '=' in line and 'class_npb' not in line:
                try:
    ...
    def run_single_benchmark(self, class_name: str, threads: int, iteration: int) -> Optional[BenchmarkResult]:
        ...
        try:
            ...
            parsed = self.parse_npb_output(result.stdout)
    ...
    def analyze_code_quality(self) -> QualityMetrics:
        ...
        metrics.loc_cpp = total_lines
        print(f"  📊 C++ LOC: {metrics.loc_cpp}")
    ...
    def generate_comprehensive_report(self, system_info: SystemInfo, topology: Dict, 
        ...
        report_data = {
            ...
            'code_quality': {
                'cpp_loc': quality_metrics.loc_cpp,
    ...
    def _generate_markdown_report(self, data: Dict):
        md_content = f"""# NPB-CPP Comprehensive Analysis Report
...
| Metric | Value |
|--------|-------|
| C++ Lines of Code | {data['code_quality']['cpp_loc']:,} |
...
def main():
    if len(sys.argv) < 4:
        ...
        print("Example: python3 unified_npb_analyzer.py ./bin/ep.A ABC 8 5")
        print("")
        print("This unified tool performs:")
        print("  1. Basic benchmark runs with detailed timing")
        print("  2. Code quality analysis (LOC, binary size)")
    ...
    print("🔬 NPB-CPP Unified Benchmark & Analysis Tool")
    print("=" * 60)
